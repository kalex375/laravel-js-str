...
var _Stringable = _interopRequireDefault(require("./Stringable"));

var _forceString = _interopRequireDefault(require("./helpers/forceString"));

var _Pluralizer = _interopRequireDefault(require("./Pluralizer"));

var _preg_match = _interopRequireDefault(require("locutus/php/pcre/preg_match"));

var _ctype_lower = _interopRequireDefault(require("locutus/php/ctype/ctype_lower"));

var _substr_count = _interopRequireDefault(require("locutus/php/strings/substr_count"));
...
var Str = /*#__PURE__*/function () {
  ...
  _createClass(Str, null, [{
     ...
     */
    function of(string) {
      return new _Stringable["default"](string);
    }
    /**
    ...
    value: function after(subject) {
      ...
      subject = (0, _forceString["default"])(subject);
    ...
    value: function ascii() {
      ...
      value = (0, _forceString["default"])(value);
    ...
    value: function contains(haystack) {
      ...
      haystack = (0, _forceString["default"])(haystack);
    ...
    value: function parseCallback(callback) {
      ...
      return Str.contains(callback, '@') ? (0, _explode["default"])('@', callback, 2) : [callback, fallback];
    }
    /**
    ...
    value: function plural(value) {
      ...
      value = (0, _forceString["default"])(value);
      return _Pluralizer["default"].plural(value, count);
    }
    /**
    ...
    value: function singular(value) {
      value = (0, _forceString["default"])(value);
      return _Pluralizer["default"].singular(value);
    }
    /**
    ...
    value: function slug(title) {
      ...
      title = (0, _forceString["default"])(title);
    ...
    value: function substr(string, start) {
      ...
      string = (0, _forceString["default"])(string);
